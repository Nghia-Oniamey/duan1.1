...
public class FormCaiDaiMail extends javax.swing.JPanel {
    ...
    public FormCaiDaiMail(List<KhachHang> list) {
    ...
    private String getNoiDungEmail() {
        String result = "Ngày " + dateThoiGian.getDateFormatString() + "\n"
                + " " + txtLoiMoDau.getText() + "\n"
                + txtNoiDung.getText() + "\n"
                + " " + txtCauKet.getText() + "\n"
    ...
    public void send(List<KhachHang> list) {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Trống", "Ngày tết", "Ngày lễ", "Chăm sóc" }));
