...
public class Menu extends JPanel {
    ...
    private final String menuItems[][] = {
        ...
        {"Dashboard"},
        {"~WEB APP~"},
        {"Quản lý sản phẩm", "Thêm sản phẩm", "sửa sản phẩm"},
        {"Quản lý hóa đơn", "Trang chủ 1", "Trang chủ 2"},
        {"Quản lý Đổi hàng", "Trang chủ 1", "Trang chủ 2"},
        {"~COMPONENT~"},
        {"Quản lý nhân viên", "Trang chủ 1", "Trang chủ 2"},
        {"Quản lý khách hàng", "Trang chủ 1", "Trang chủ 2"},
        {"~OTHER~"},
        {"Quản lý khuyến mại", "Trang chủ 1", "Quản lý khuyến mại theo sản phẩm"},
        {"Quản lý phiếu giao hàng", "Quản lý phiếu giao hàng"},
    ...
    private void init() {
        ...
        header.setIcon(new ImageIcon("/raven/icon/png/logo.png"));
